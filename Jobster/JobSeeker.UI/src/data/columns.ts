...
const mockColumns: IColumn[] = [
  {
    id: IStatus.WISHLIST,
    title: 'Wish List',
    cardsIds: ['2fab1909-0b9f-4783-976c-4ffecb805ac6'] 
  },
  {
    id: IStatus.APPLIED,
    title: 'APPLIED',
